    ...
    <div className={"ml-5 items-center"}>
      <ol className={"list-decimal space-y-5"}>
        <li>
          ...
          : Chủ nhóm Arknights&apos;s Goods - Buôn thận và cày ruộng cùng thú 4
          tai
        </li>
        <li>
          <Link
...
export default function AboutDreamchasers() {
  return (
    <div className={"p-10 sm:w-150 md:w-200 lg:w-250"}>
      <div className={"text-center text-3xl font-extrabold"}>Về tụi mình</div>
      <br />
      <div className={"items-center font-normal"}>
        <p>
          ...
          <Link
            href={"https://www.facebook.com/groups/arknights.vietnam.station"}
            className={"underline"}
          >
            <b>Arknights Vietnam Station [Arknights VNS]</b>
          </Link>
          , đồng thời cũng là một trong những nhánh của Station Network /
          Project VNS
        </p>
        <br />
        <p>
          Arknights VNS hiện có các nền tảng khác để kết nối cộng đồng trong
          Project VNS như:{"\n\n"}
        </p>
        <br />
        <ul className={"ml-10 list-disc space-y-5"}>
          <li>
            ...
            : Fanpage chính thức của nhóm, là một team chuyên dịch truyện tranh
            được phát hành bởi Hypergryph (dưới tên Terra Historicus) hoặc
            fanart cộng đồng. Ngoài ra, page thỉnh thoảng cũng sẽ cập nhật &
            chia sẻ các nội dung, tin tức liên quan đến Arknights.
          </li>
          <li>
